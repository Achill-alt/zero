...
| 审批链 | 4 | 标准四级 / 小额简易 / 紧急采购 / 大额采购（优先级匹配演示） |
| 合同模板 | 5 | 采购 / 销售 / 服务 / 租赁 / 合作备忘录（均支持富文本） |
| 合同 | 21 | 覆盖全部 5 状态 × 5 类型（含 14/30/45 天分批到期、多链演示） |
| 审批实例 | 5 | step 0~4 各阶段（部门→法务→财务→总经理） |
| 通知 | 22 | 5 个用户，14 未读 / 8 已读 |
...
| 审批中 | 5 | IT运维服务 (step 0/4) / 软件许可采购 (step 1/4) / 市场推广服务 (step 2/4) / 员工团建 (step 3/4) / 年度文具采购 (小额 step 0/2) |
| 已通过 | 7 | 年度销售代理 ¥500K / 云计算服务 ¥180K / 工厂设备租赁 ¥350K / 渠道合作 ¥650K / 战略合作备忘录 ¥0（14天到期）/ 办公用品 ¥30K（已过期）/ 紧急防疫 ¥85K |
| 已归档 | 3 | 仓库租赁 2025 / 网络安全 2024 / 服务器采购 2024 |
| 已作废 | 2 | 法律咨询（资质变更）/ 物流配送（价格未达成一致） |

> 到期预警演示：已过期 1 份 + 14/30/45 天分别到期各 1 份
